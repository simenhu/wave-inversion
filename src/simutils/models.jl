...
function general_one_dimensional_wave_equation_with_parameters_non_staggered(domain, internal_nodes, p; excitation_func, excitation_positions, pml_width)
    ...
    function du_func(state, p, t)
        ...
        A_xv = CenteredDifference{1}(1, 2, dx, internal_nodes, b_coeffs)
        A_xu = CenteredDifference{1}(1, 2, dx, internal_nodes, a_coeffs)
        Q_v = Dirichlet0BC(Float64)
        Q_u = Dirichlet0BC(Float64)
