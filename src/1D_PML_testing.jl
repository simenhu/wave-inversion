...
## Define ODE function
f = general_one_dimensional_wave_equation(string_length, number_of_cells, a_coeffs, b_coeffs, excitation_func=[f_excitation], excitation_positions=[150], pml_width=60)
